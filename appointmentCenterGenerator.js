...
module.exports = (apikey, environment, country, storage) => {
    ...
    reviews.src = `${storage}/static/widgets/appointmentCenter/td-appointment-center.min.js`
    ...
    const container = document.querySelector('#topdoctors-' + country + '-widget-container-16')
    const component = document.createElement('td-appointment-center')
    setTimeout(() => {
      component.setAttribute('environment', env)
      component.setAttribute('api-key', apikey)
      component.setAttribute('region', country)
      component.setAttribute('widget-type', '16')
