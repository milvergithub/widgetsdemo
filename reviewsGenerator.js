...
module.exports = (apikey, environment, country, storage) => {
    ...
    reviews.src = `${storage}/static/widgets/reviews/td-reviews.min.js`
    ...
    const container = document.querySelector('#topdoctors-' + country + '-widget-container-3')
    const component = document.createElement('td-reviews')
    component.setAttribute('environment', env)
    component.setAttribute('api-key', apikey)
    component.setAttribute('region', country)
    component.setAttribute('widget-type', 3)
