...
module.exports = (provider, environmentURL, country, storage) => {
    const i18n = {
      'es-ES': {
        header: "Telemedicina",
        description: 'Contacta ahora mediante <strong>mensajería privada</strong> o <strong>videoconsulta</strong> con el magiclink del centro.',
    ...
    const widget = document.getElementById('topdoctors-'+country+'-widget-container-15')
    ...
    link.setAttribute(
      'href',
      `${environmentURL}/${providerType[provider.type]}/${provider.slug}?telemedicine=true`
    )
